var pkp1_1 = getTag('data_lme_1');     

eval('data =' + pkp1_1);     

if(typeof data == 'object') { 

//setTag('pkp1.1_a1.1', data['ai_pkp1.1'][0]);

//setTag('pkp1.1_a1.1', data.ai_pkp1.1[0]);     // Temp Cooling Tank 1
//setTag('pkp1.1_a1.2', data.ai_pkp1.1[1]);     // Temp Holding Tank 1
//setTag('pkp1.1_a1.3', data.ai_pkp1.1[2]);     // Temp Cooling Tank 5
//setTag('pkp1.1_a1.4', data.ai_pkp1.1[3]);     // Temp Holding Tank 6
//setTag('pkp1.1_a1.5', data.ai_pkp1.1[4]);     // Temp Cooling Tank LM3
//setTag('pkp1.1_a1.6', data.ai_pkp1.1[5]);     // Temp Holding Tank LM3
//setTag('pkp1.1_a1.7', data.ai_pkp1.1[6]);     // Not used
//setTag('pkp1.1_a1.8', data.ai_pkp1.1[7]);     // Not Used
